...
format: 
  html:
    fig-width: 8          # inches – wide enough for most dashboards
    fig-height: 5.5       # inches – keeps a pleasant aspect ratio
    fig-align: center
    fig-dpi: 150          # crisp on screen, still lightweight
    dev: svg  
    lightbox: 
      match: auto
      effect: fade
...
params:
  ...
  cihi_path: data/cihi/supply-distribution-migration-physicians-in-canada-2001-2024-data-tables-en.xlsx
---
